...
contract MockVEPENDLE {
    ...
    function unlock(uint256 amount) external {
        ...
        require(block.timestamp >= unlockTimes[msg.sender], "Lock period not ended");
...
contract xPENDLETest is Test {
    xPENDLE public vault;
    MockVEPENDLE public vePendle;
    ...
    function test_Constructor() public {
        assertEq(address(vault.vePendle()), address(vePendle));
        ...
        assertEq(vault.currentEpoch(), block.timestamp / 1 days);
    }
    ...
    function test_WithdrawalQueue() public {
        ...
        xPENDLE.WithdrawalRequest[] memory requests = vault.getUserWithdrawalRequests(alice);
    ...
    function test_GovernanceFunctions() public {
        ...
        // Test lock duration
        vault.setLockDurationDefault(30 days);
        assertEq(vault.lockDurationDefault(), 30 days);
    ...
    function test_RevertInvalidLockDuration() public {
        ...
        vault.setLockDurationDefault(12 hours); // Less than 1 day
        
        vm.expectRevert("Duration too long");
        vault.setLockDurationDefault(366 days); // More than 365 days
    }
